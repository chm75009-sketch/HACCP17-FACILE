...
function env(opts) {
  ...
  const e = {
    ...
    _scrollHaut: function () {}, showPage: function () { e._showed = true; }, APP_BUILD: 'v193', renderEuCampagne: function () {},
...
(async function () {
  ...
  { // bon mot de passe -> tableau de bord
    ...
    ok(t.doc._registry['adminVersion'].textContent === 'v193', 'admin login: version affichée');
  }
  // ════════════ B) DÉCONNEXION ADMIN ════════════
  {
